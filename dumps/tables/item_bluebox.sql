...
--
-- Dumping data for table `item_bluebox`
--

LOCK TABLES `item_bluebox` WRITE;
/*!40000 ALTER TABLE `item_bluebox` DISABLE KEYS */;
/*!40000 ALTER TABLE `item_bluebox` ENABLE KEYS */;
UNLOCK TABLES;
