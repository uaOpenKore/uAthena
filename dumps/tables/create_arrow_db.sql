...
--
-- Dumping data for table `create_arrow_db`
--

LOCK TABLES `create_arrow_db` WRITE;
/*!40000 ALTER TABLE `create_arrow_db` DISABLE KEYS */;
/*!40000 ALTER TABLE `create_arrow_db` ENABLE KEYS */;
UNLOCK TABLES;
