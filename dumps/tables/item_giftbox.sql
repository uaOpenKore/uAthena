...
--
-- Dumping data for table `item_giftbox`
--

LOCK TABLES `item_giftbox` WRITE;
/*!40000 ALTER TABLE `item_giftbox` DISABLE KEYS */;
/*!40000 ALTER TABLE `item_giftbox` ENABLE KEYS */;
UNLOCK TABLES;
