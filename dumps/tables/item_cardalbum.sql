...
--
-- Dumping data for table `item_cardalbum`
--

LOCK TABLES `item_cardalbum` WRITE;
/*!40000 ALTER TABLE `item_cardalbum` DISABLE KEYS */;
/*!40000 ALTER TABLE `item_cardalbum` ENABLE KEYS */;
UNLOCK TABLES;
